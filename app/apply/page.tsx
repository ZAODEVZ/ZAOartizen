...
const STEPS: Step[] = [
  ...
  { n: 4, title: 'Rally + sell', body: 'Every Artifact a fan buys unlocks match from the ZAO Fund, and stacks across any other fund backing you. The match rate is set per drive, so it moves week to week - the more people who buy, the higher you climb.' },
];
