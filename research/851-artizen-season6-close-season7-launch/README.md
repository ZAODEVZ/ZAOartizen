...
- **Live current ZAO Fund rank/pool for Season 7** - not captured. Season 7 just started (July 9), so a rank/pool check now would just show a near-empty reset fund; more useful to check in 1-2 weeks once Season 7 activity accrues. The June 21 snapshot (#11, $10,547 pool, $4,262 deployed, $6,331 remaining, score 522.19) is now a Season-6-era number and should not be quoted going forward.
...
| Ask in the Funders Forum or Grow app directly whether Global Music Fund and Bonfires Fund exist and how to cross-curate | @Zaal | Outreach | Next Funders Forum |
...
| Re-check ZAO Fund's Season 7 rank/pool once Season 7 activity has accrued (do not use the June 21 Season-6 snapshot) | @Claude | Verification | 2026-07-27 |
